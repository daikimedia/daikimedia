...
import { Tag, Star, MapPin, Users, Clock, Briefcase, Search, ChevronDown, ArrowUpRight, ChevronsLeftRightEllipsis } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row items-start justify-between mb-6 gap-4">
                <div className="flex items-center space-x-4 w-full sm:w-auto">
                    ...
                    <div className="min-w-0 flex-1">
                        <div className="flex items-center space-x-2">
                            <h2 className="text-lg sm:text-2xl font-semibold text-gray-900 truncate">{company.name}</h2>
                        </div>
                        <div className="flex items-center space-x-2 mt-1">
                            {company.rating > 0 ? (
                                <div className="flex items-center">
                                    <span className="text-lg sm:text-xl font-bold text-gray-900">{company.rating}</span>
                ...
                <div className="w-full sm:w-auto">
                    <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                        ...
                        <Link href="https://api.whatsapp.com/send?phone=601114850067" passHref legacyBehavior>
                            <a
                                target="_blank"
                                rel="noopener noreferrer"
...
const FilterDropdown = ({ label, icon, options, value, onChange, placeholder }) => {
    ...
    useEffect(() => {
        ...
        if (selectedPriceRange) {
            filtered = filtered.filter(company => {
                ...
                if (selectedPriceRange === '<$1,000') return priceRange.includes('1,000') && priceRange.includes('<');
                if (selectedPriceRange === '$1,000-$3,000') return priceRange.includes('1,000');
                if (selectedPriceRange === '$3,000-$5,000') return priceRange.includes('3,000') || priceRange.includes('5,000');
                if (selectedPriceRange === '$5,000-$10,000') return priceRange.includes('5,000');
                if (selectedPriceRange === '$10,000-$50,000') return priceRange.includes('10,000');
                if (selectedPriceRange === '$50,000+') return priceRange.includes('50,000');
                return true;
            });
        }
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                        ...
                        <div className="w-full">
                            <FilterDropdown
                                ...
                                value={selectedRating ? ratingOptions.find(opt => opt.value === selectedRating)?.label : ''}
                        ...
                        <div className="w-full">
                            <FilterDropdown
                                ...
                                value={selectedTeamSize ? teamSizeOptions.find(opt => opt.value === selectedTeamSize)?.label : ''}
